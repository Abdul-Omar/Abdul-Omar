...
<article class="mw5 flex-left bg-white br3 pa3 pa4-ns mv0 ba borderr1 b--black-10 mt4 pt4 ">
  <div class="tc">
    ...
    <img src={Github} class="br-100 h3 w3 dib" title="Photo of Abdul"/>
   ...
   <img src={LinkedIn} className="br-100 h3 w3 dib" title="Photo of Abdul"/>
   ...
   <a className="link near-black hover-silver dib mh3 pv4 tc" href="https://medium.com"  target="_blank">
    <img src={Medium} class="br-100 h3 w3 dib" title="Photo of Abdul"/>
